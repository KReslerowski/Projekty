...
goldAcquired = 0
print("You have only 5 steps to make, see yourself how much gold you gonna acquire till the end!")
...
while gameLength > 0:
    ...
    if (gamerAnswer == "yes"):
        ...
        if (drawnEvent == Event.Chest):
            ...
            drawnColour = random.choices(chestColourList,chestColourProbabilyesity)[0]
